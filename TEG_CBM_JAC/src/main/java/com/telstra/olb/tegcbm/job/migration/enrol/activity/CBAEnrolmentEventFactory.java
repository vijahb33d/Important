...
import com.telstra.olb.tegcba.accountenrolment.model.EnrolmentEvent;
import com.telstra.olb.tegcba.accountenrolment.model.EnrolmentEventNotification;
import com.telstra.olb.tegcba.common.AccountRelationType;
import com.telstra.olb.tegcba.common.AccountType;
import com.telstra.olb.tegcba.common.EnrolmentType;
 ...
 */
public final class CBAEnrolmentEventFactory implements EnrolmentEventFactory {
    private static Log log = LogFactory.getLog(CBAEnrolmentEventFactory.class);

    private static CBAEnrolmentEventFactory instance = null;
     ...
     */
    public static CBAEnrolmentEventFactory getInstance() {
        if (instance == null) {
            instance = new CBAEnrolmentEventFactory();
        }
        return instance;
    }
     ...
     *  
     */
    private CBAEnrolmentEventFactory() {
